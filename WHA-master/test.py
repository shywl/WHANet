...
from model import WHA

torch.backends.cudnn.benchmark = True

###################---------Arguments---------###################
# Training settings
parser = argparse.ArgumentParser(description="WHA")
...
parser.add_argument('--folder_lq', type=str, default="./TestData_LR/Urban100/", help='input low-quality test image folder')
parser.add_argument('--folder_gt', type=str, default="./TestData_GT/Urban100/", help='input ground-truth test image folder')
...
begin_epoch=1
train_loss={}
checkpoint_file=os.path.join(args.output_dir, 'checkpoint_780.pth')
