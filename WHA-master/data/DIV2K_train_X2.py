...
class div2k(data.Dataset):
    ...
    def _set_filesystem(self, dir_data):
        # self.dir_hr = r"/mnt/workspace/Urban 100/X4 Urban100/X4/HIGH x4 URban100"
        # self.dir_lr = r"/mnt/workspace/Urban 100/X4 Urban10DIV2K_train.py0/X4/LOW x4 URban100"
        self.dir_hr = r"/data2/aipub/tm/DIV2K/DIV2K_train_HR"
        self.dir_lr = r"/data2/aipub/tm/DIV2K/DIV2K_train_LR_bicubic/X2"
